                    ...
                    <CardHeader className="cursor-pointer hover:bg-white/5 transition-all p-4 rounded-xl">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <CardTitle className="text-sm font-bold tracking-tight">Milestones</CardTitle>
                ...
                <CollapsibleContent>
                    <CardContent className="pb-6 pt-0 px-4">
                        <div className="flex flex-col h-full min-h-0">
                            <ScrollArea className="flex-1 -mr-4 pr-4 mb-4 max-h-[400px]">
                                {tasks.length === 0 ? (
                                    <div className="h-40 flex flex-col items-center justify-center text-muted-foreground/30 text-center border-2 border-dashed border-white/5 rounded-2xl mt-2">
